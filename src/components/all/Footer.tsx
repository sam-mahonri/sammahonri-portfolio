            ...
            <div className=" w-full flex flex-col gap-4 justify-center items-center">
                <div className="flex md:flex-wrap md:flex-row flex-col md:gap-16 gap-10 md:items-start justify-center w-full my-4 p-6">
                    ...
                    <div className="flex flex-col justify-center items-center gap-1 md:mt-0 mt-6">
                        ...
                        <Link className="olink font-unbounded " href={"https://x.com/ZhyrelDragon"}>Twitter</Link>
                        <Link className="olink font-unbounded " href={"https://open.spotify.com/intl-pt/artist/2E51QaIVG0zooDl9u1EN0B?si=-MKDBpkbTcanT_fgyEmjeQ"}>Spotify</Link>
                        <Link className="olink font-unbounded " href={"https://bsky.app/profile/zhyrel.com"}>Bluesky</Link>
