...
export function NewMusic() {
    ...
    return <>
        {visible && <div className=" items-center justify-center z-50 fixed flex flex-wrap gap-2 bottom-0 left-0 w-full p-2 bg-surface border-t-2 border-secondary">
            <h5 className=" mx-1 md:mr-6 flex flex-row gap-4 md:w-fit w-full items-center"> <button onClick={() => setVisible(false)} className=" p-1.5 hover:bg-secondary hover:text-background transition-colors"> <XMarkIcon /> </button>  NOVA MÚSICA </h5>
