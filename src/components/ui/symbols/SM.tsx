...
export function TypingSM() {
    ...
    useEffect(() => {
        ...
        const actionsMap: Partial<Record<string, Function>> = {
            ...
            'kegaw': () => router.push("/arts?art=7"),
            'henricco': () => router.push("/arts?art=11"),
            'inserty': () => router.push("/arts?art=39"),
            'mitsu': () => router.push("/arts?art=56"),
            'diogo': () => router.push("/arts?art=64"),
            'boluh': () => router.push("/arts?art=47"),
            'kyosa': () => router.push("/arts?art=42"),
