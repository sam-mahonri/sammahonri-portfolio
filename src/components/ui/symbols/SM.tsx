...
export function TypingSM() {
    ...
    useEffect(() => {
        ...
        const actionsMap: Partial<Record<string, Function>> = {
            ...
            'kegaw': () => router.push("/arts?art=8"),
            'henricco': () => router.push("/arts?art=12"),
            'inserty': () => router.push("/arts?art=40"),
            'mitsu': () => router.push("/arts?art=57"),
            'diogo': () => router.push("/arts?art=65"),
            'boluh': () => router.push("/arts?art=48"),
            'kyosa': () => router.push("/arts?art=43"),
            'kassio': () => router.push("/arts?art=4"),
