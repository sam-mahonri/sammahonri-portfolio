    ...
    return (
        <div className=" w-full z-30">
            ...
            <Reveal width="100%" delay={0.5}>
                <span className={clsx("w-full fixed left-0 top-20 pointer-events-none transition-colors h-12 duration-500", { "bg-surface/80 backdrop-blur-sm": isSticky, "bg-transparent": !isSticky })}></span>
